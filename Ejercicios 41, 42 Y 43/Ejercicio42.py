...
#Se importaron las librerias sys, platform y subprocess.

import sys #Sirve para interactuar y manipular el entorno de la ejecución, oermitiendo acceder a variables y funciones especificas del sistema
import platform #Permitir escribir código que se pueda adaptar al entorno en el que se esta ejecutando.
import subprocess #Este permite ejecutar comandos externos y crear nuevos procesos directamente de un scrip de Python.
