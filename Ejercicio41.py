...
class Alumno:
    #Agregar
    #El aluno tiene nombre, num_control_ y carrera.
    #Cada uno sirve para rregistrar al alumno.
    #Agrege la CURP porque es un atributo para identificar a la persona, al ser muy diferente cada curp.  
    def __init__(self, nombre: str, numero_control: str, carrera=None, curp: str):
        self.nombre = nombre
